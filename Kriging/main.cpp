...
void print_usage()
{
	...
	printf("kriging [input file] [output file] [field index] [cellsize] [number of nearest points] [nugget] [height of arc] [range]\n");
}
/*
 * 
 */
int main(int argc, char** argv) {
	...
	if(tid==0)
	{
		...
		for(int k=1;k<numprocs;k++)
		{
			...
			nYSize2 = (i+1)*yStride>nYSize?nYSize-i*yStride:yStride;
